        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-4">
          ...
          <div className="space-y-4 max-w-[300px]">
            ...
            <p className="text-dark2">
              BrainBoost is a platform dedicated to teach programming aspiring people.
          ...
          <div className="space-y-4 max-w-[300px]">
            ...
            <div className="flex space-x-6 py-3">
              ...
              <a href="https://www.instagram.com/awinulhoque/">
                <FaInstagram className="cursor-pointer hover:text-primary hover:scale-105 duration-200" />
              </a>
              <a href="https://scholar.google.com/citations?user=93PTwHEAAAAJ&hl=en&oi=ao">
                <TbWorldWww className="cursor-pointer hover:text-primary hover:scale-105 duration-200" />
              </a>
              <a href="https://www.youtube.com/@AkidulMusic47">
